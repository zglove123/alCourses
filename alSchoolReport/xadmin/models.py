...
class UserSettings(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL,on_delete=models.CASCADE,blank=True, null=True, verbose_name=_(u"user"))
...
class UserWidget(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL, verbose_name=_(u"user"),on_delete=models.CASCADE,blank=True, null=True)
